...
public class Ball implements Sprite {
     ...
     */
    public Ball(int x, int y, int r, java.awt.Color color, boolean isShoot) {
        this.radius = r;
        this.color = color;
 ...
 */
    ...
    public void setVelocity(Velocity vel1) {
        this.vel = new Velocity(vel1.getDx(), vel1.getDy());
    }
    ...
    public void moveOneStep(double dt) {
        ...
        Point pointAfterStep = velo.applyToPoint(this.center);
